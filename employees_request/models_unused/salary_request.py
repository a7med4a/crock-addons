...
class salary_request(models.Model):
    ...
    balance_flag = fields.Char(
        string="Balance Flag", required=False, compute="cal_balance_flag"
    )
    salary_value = fields.Float(
        string="Salary Value", readonly=True, states={"draft": [("readonly", False)]}
    )
    month_due = fields.Date(
        string="Month Due", readonly=True, states={"draft": [("readonly", False)]}
    )
    ...
    debit_account_id = fields.Many2one(
        ...
        readonly=True,
        states={"draft": [("readonly", False)]},
        default=lambda self: self.env.company.req_salary_acc_debit_id.id,
    )
    credit_account_id = fields.Many2one(
        ...
        readonly=True,
        states={"draft": [("readonly", False)]},
        default=lambda self: self.env.company.req_salary_acc_credit_id.id,
    )
    journal_id = fields.Many2one(
        ...
        readonly=True,
        states={"draft": [("readonly", False)]},
        default=lambda self: self.env.company.req_salary_journal_id.id,
    )
